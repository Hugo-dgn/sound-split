...
class Network19(Network):
    def __init__(self, gen, checkpoint):
        Network.__init__(self, 19, gen, checkpoint)
        
        self.freq_loss = 0
        self.time_loss = 0
        self.uipt_loss = 1
        
        self.e1 = encoder1D_block(1, 8, kernel_size=51, num_conv=2)
        self.e2 = encoder1D_block(8, 16, kernel_size=21, num_conv=2)
        self.e3 = encoder1D_block(16, 32, kernel_size=13, num_conv=2)
        self.e4 = encoder1D_block(32, 64, kernel_size=5, num_conv=2)
        self.e5 = encoder1D_block(64, 64, kernel_size=5, num_conv=2)
        
        self.separator = nn.LSTM(input_size=64, hidden_size=32, num_layers=3, batch_first=True, bidirectional=True)
        
        self.d1 = decoder1D_block(64, 32, 64, kernel_size=3, num_conv=1)
        self.d2 = decoder1D_block(32, 16, 64, kernel_size=5, num_conv=1)
        self.d3 = decoder1D_block(16, 8, 32, kernel_size=7, num_conv=1)
        self.d4 = decoder1D_block(8, 4, 16, kernel_size=11, num_conv=1)
        self.d5 = decoder1D_block(4, 2, 8, kernel_size=15, num_conv=1, activation=nn.Identity, normalize=False)
